...
public:
    ...
    static bool parse(const std::string& filepath, RenderData &renderData);

    static glm::mat4 getTransformationMatrix(SceneTransformation *transform);

    static void populateRenderData(RenderData *renderData, SceneNode *root, glm::mat4 currentCTM);
};
