...
void Realtime::initializeGL() {
    ...
    m_skyblock_shader = ShaderLoader::createShaderProgram("/Users/christinapeng/pixel-grove/resources/shaders/skyblock.vert", "/Users/christinapeng/pixel-grove/resources/shaders/skyblock.frag");
...
int Realtime::loadCubemap(std::vector<std::string> faces)
{
